...
#Working directories------------------------
wd_script_src <- c('W:/RICHCWA/WinModel/EFDC/R_Scripts/EFDC_Results_Figures/Component_Analysis')
wd_data_src <- paste('W:/RICHCWA/WinModel/EFDC/RICHCWA_Grid02/', scenario_name, sep = '')
wd_component_data_src <- paste('W:/RICHCWA/WinModel/EFDC/RVAJR_Components/', scenario_name, sep = '')

#Parameters used in 00_Read_EFDC_Data_xlsb_Format.R------------
file_name_efdc <- c('EFDC_export_011917-1631.xlsb')
rds_name_efdc <- paste(scenario_name, '_test_data.rds', sep = '')

#Parameters used in 00_Read_Component_Data_xlsb_Format.R-------
file_name <- c('EFDC_Template_Development_Data.xlsb')
rds_name <- paste(scenario_name, '_component_test_data.rds', sep = '')
